...
const APP_NAME = "Latino Mini Market";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Latino Mini Market — grocery, deli, and butcher on Bridge Street in Phoenixville, PA. Hispanic, American, and Brazilian products. SNAP/EBT welcome. Open 9 AM–9 PM daily. 317 Bridge St, (610) 917-8800.",
      },
